...
const Navbar = () => {
    ...
    return (
        <div>
            <nav className="bg-[#97DEFF]">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-16">
                        <div className="flex items-center">
                            <div className="flex-shrink-0">
                                <Link to="/">
                                    <h1 className='text-4xl ml-2 font-bold text-blue-800 inline-block'>BookNow</h1>
                                </Link>
                            </div>
                            <div className="hidden md:block">
                                <div className="ml-10 flex items-baseline space-x-4">
                                    ...
                                    {!loginStatus &&
                                        <Link to="/login">
                                            <button class=" bg-[#0284c7] hover:bg-red-200 text-white font-bold py-2 px-4 rounded">
                                                Log In
                                            </button>
                                        </Link>
                                    }
